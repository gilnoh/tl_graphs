...
public class FinalGraph<V,E> extends DefaultDirectedWeightedGraph<V,E>{
	
	Class<? extends V> vertexClass;
	
	public FinalGraph(EdgeFactory<V, E> arg0) {
		super(arg0);
		// TODO Auto-generated constructor stub
	}

	public FinalGraph(Class<? extends E> arg0) {
		super(arg0);
		// TODO Auto-generated constructor stub
	}
	...
	public <WV, WE> void convertGraph(WorkGraph<WV, WE> wg) {
		// iterate over wg's vertices and build the corresponding FinalGraph nodes,
		...
		try {
			...
			for(WV wv: wg.vertexSet()) {
				V v = (V) vconstr.newInstance(wv);  //(V) new FinalGraphNode((WorkGraphNode) wv);
				nodeMap.put(wv, v);
				this.addVertex(v);
